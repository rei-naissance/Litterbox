...
urlpatterns = [
    ...
    path('announcement/<int:announcement_id>/edit', views.announcement_edit, name='announcement_edit'),
    path('announcement/<int:announcement_id>/delete', views.announcement_delete, name='announcement_delete'),
